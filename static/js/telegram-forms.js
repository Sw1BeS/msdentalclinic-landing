...
function injectImplantLandingStyles() {
    ...
    style.textContent = `
        ...
        @media(min-width:1024px){.hero-container-offers{grid-template-columns:minmax(0,.92fr) minmax(420px,1fr)}.quiz-shell{grid-template-columns:.9fr 1.1fr;padding:46px}}@media(max-width:767px){.hero-actions{justify-content:center}.hero-main-cta,.hero-secondary-cta{width:100%}.hero-offer-panel{min-height:650px;padding:22px;border-radius:26px}.offer-slider{min-height:320px}.hero-offer-panel .offer-visual-wrap{right:50%;transform:translateX(50%);bottom:128px;width:260px}.hero-offer-panel .offer-bottom-row{left:18px;right:18px;bottom:18px;align-items:stretch;flex-direction:column}.countdown-grid,.mini-countdown{grid-template-columns:repeat(4,1fr)}.countdown-grid span,.mini-countdown span{min-width:0}.offer-controls{justify-content:center}.quiz-shell{padding:18px;border-radius:24px}.quiz-card{padding:20px;min-height:570px;border-radius:22px}.quiz-options button{font-size:14px;padding:14px 16px}}
    `;
