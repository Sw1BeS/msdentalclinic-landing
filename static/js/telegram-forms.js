    ...
    imageContainer.outerHTML = `
        <div class="hero-offer-panel reveal" data-offer-carousel>
            <div class="offer-slider" aria-live="polite">
                <article class="offer-slide active" data-offer-slide><span class="offer-kicker">Пропозиція 01</span><h2>Безкоштовна консультація імплантолога</h2><p>Для пацієнтів, які залишили заявку з цієї посадкової сторінки.</p><ul><li>Оцінка клінічної ситуації</li><li>Попередній план лікування</li><li>Пояснення варіантів за бюджетом</li></ul></article>
                <article class="offer-slide" data-offer-slide><span class="offer-kicker">Пропозиція 02</span><h2>Тимчасові зуби орієнтовно за 7 днів</h2><p>Актуально для пацієнтів, які не хочуть залишатися без посмішки під час лікування.</p><ul><li>План тимчасового протезування</li><li>Підбір імплантаційної системи</li><li>Пояснення етапів і строків</li></ul></article>
                <article class="offer-slide" data-offer-slide><span class="offer-kicker">Пропозиція 03</span><h2>All-on-4 / All-on-6 під ключ</h2><p>Комплексне відновлення зубного ряду з чіткою послідовністю етапів.</p><ul><li>Сценарії для повної реабілітації</li><li>Порівняння систем імплантів</li><li>Орієнтир по термінах і підготовці</li></ul></article>
            </div>
            ...
            <div class="offer-bottom-row">
                <div class="offer-countdown" data-countdown="main" data-countdown-hours="48"><span class="countdown-label">Персональна пропозиція активна ще:</span><div class="countdown-grid" aria-live="polite"><span><strong data-countdown-days>02</strong><small>дні</small></span><span><strong data-countdown-hours>00</strong><small>год</small></span><span><strong data-countdown-minutes>00</strong><small>хв</small></span><span><strong data-countdown-seconds>00</strong><small>сек</small></span></div></div>
